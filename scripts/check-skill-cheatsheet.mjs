...
const SKILL_PATH = join(REPO_ROOT, 'transitrix', 'skills', 'onboard', 'SKILL.md');
...
// Pull the family-selection matrix from transitrix/skills/onboard/SKILL.md.
...
function reportFailure(failures) {
  ...
  console.error(
    `\nFix the Skill (transitrix/skills/onboard/SKILL.md) to match the canon ` +
