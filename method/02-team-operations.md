...
For the step-by-step setup — creating the folder, the authoring skill, the CI guard, and (later) the central harvest — see [`method/05-adr-adl-adoption.md`](05-adr-adl-adoption.md).
