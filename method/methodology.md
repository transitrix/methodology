...
See `notations/03-fgca.md` for the full FGCA notation reference (file format, fields, examples, DSM implementation status). See `notations/04-fga.md` for the FGA variant.
