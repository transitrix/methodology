...
**Version:** 1.0
**Date:** 2026-05-04
**Scope:** Catalogue of rules enforced on every `.bpmn.transitrix.yaml` document. Errors block compilation; warnings are surfaced but non-blocking. Each rule has a stable ID for use in tooling output.
...
A project may suppress warnings by including a configuration file (default name `.transitrixrc`) at the root of its source tree:
