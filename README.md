...
- **[`method/05-adr-adl-adoption.md`](method/05-adr-adl-adoption.md)** — standing up architecture decision records per repo and the harvested enterprise log across repos: setup steps, commands, and the policy calls to make first.
