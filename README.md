...
- **[Desktop model workplace](guides/desktop-model-workplace.md)** — Qualified read-only setup paths for ChatGPT Desktop and Claude Desktop, with connection and evidence checks.
