...
- **[`guides/`](guides/)** — task and component procedures that don't fit the reading order above (unnumbered — a menu, not a sequence): modelling capabilities, modelling complex processes, adopting the Architecture Decision Log, how a model-backed document prints.
