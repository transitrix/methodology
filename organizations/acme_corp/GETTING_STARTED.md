# Getting Started with LiteEA

Welcome to the LiteEA Architecture-as-Code methodology! This guide will walk you through your first architecture modeling exercise.
...
Read `method/LiteEA Методология управления архитектурой предприятия.md` for complete methodology details.
...
```bash
cp .templates/bpmn/process_template.bpmn.yaml \
...
Examples:
- SALES_MANAGER.yaml
- ORDER_FULFILLMENT_process.bpmn.yaml
- POSTGRES_PROD.yaml
```
...
- Read the full methodology: `method/LiteEA Методология управления архитектурой предприятия.md`
