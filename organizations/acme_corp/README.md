...
├── 0.archive/                   # Archive directory for old files (instead of deletion)
...
- **BusinessProcess**: End-to-end processes (often .bpmn.yaml)
...
- See `method/LiteEA Методология управления архитектурой предприятия (Architecture-as-Code).md` for full methodology
...
Edit `.validators/lint.py` and add a method to the `LiteEALinter` class:
...
This methodology and templates are part of the LiteEA project.
