...
Detailed BPMN 2.0 process flow diagrams. Each file describes the internal flow of a single BusinessProcess element (the thin metadata for which lives at `elements/02_business/<PROCESS_ID>.yaml`).
...
- `elements/02_business/` — thin BusinessProcess element files
