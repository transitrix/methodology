...
function usage() {
  return [
    ...
    '                 codex: --type LAW|REGULATION|STANDARD|POLICY|INTERNAL_STANDARD|PRINCIPLE --effective-date YYYY-MM-DD',
    '                        (--effective-date optional for PRINCIPLE; PRINCIPLE instead requires --statement --rationale)',
    '                        STANDARD requires --jurisdiction and --issuing-authority (the issuing body)',
