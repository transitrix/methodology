...
// + validation flags, any below-threshold relation suggestions, and any role
// assignment proposals (person->role, e.g. from an approver sign-off chain). Emitted
// as YAML (write-only via the dumper). NOTHING here is admitted to canon.
...
export async function buildReviewQueue({ orgRoot, candidatesDir, profile, suggestions = [], roleAssignmentProposals = [] }) {
