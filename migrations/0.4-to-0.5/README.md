...
- An obligation the org must fulfil → create a `REQUIREMENT-…` element under `canon/elements/01_motivation/requirements/` with `derived_from: [<codex artefact ID>]` (see [`15-requirement.md`](../../notations/elements/15-requirement.md)).
- A compliance claim about a subject → create an `ASSERTION-…` under `canon/assertions/` linking the requirement to the subject (see [`16-assertion.md`](../../notations/elements/16-assertion.md)).
...
- Spec sources for the transforms shipped:
  - Codex `applies_to` retirement — [`notations/elements/14-codex.md`](../../notations/elements/14-codex.md) §8.
  ...
  - Goal `parent` → REL `goal_parent` — [`notations/views/04-goals.md`](../../notations/views/04-goals.md) "Time-aware relations" + [`notations/elements/17-relations.md`](../../notations/elements/17-relations.md) §3 (enum) and §6 (migration).
  - Activity `goals: [GOAL-…]` → REL `activity_goal` — [`notations/views/07-activities.md`](../../notations/views/07-activities.md) "Time-aware relations" + [`notations/elements/17-relations.md`](../../notations/elements/17-relations.md) §3 (enum) and §6 (migration).
