...
| Script | Purpose | When |
|---|---|---|
| `test_knowledge_store_integrity.py` | Runs `tools/knowledge_store_lint.py` on fixtures; asserts KS-001..017 behaviour | Every PR touching the skill, linter, or pattern doc; CI job `knowledge-store-lint-test` |
