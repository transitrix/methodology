...
| Transitrix Repository MCP Server | [transitrix-repository-mcp.md](transitrix-repository-mcp.md) | Simple or Full | Recommended governed semantic access; [enterprise reference](../guides/repository-mcp-enterprise.md) covers scope/operation rights, deployment, and compatible assistant modes. |
...
| "How do managers and engineers access different parts of one model?" / "Which database and deployment fit?" | [Repository MCP enterprise reference](../guides/repository-mcp-enterprise.md) |
