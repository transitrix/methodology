...
| Baseline, Audit Trail and Approval Record | [baseline-and-audit-trail.md](baseline-and-audit-trail.md) | Full | Overlay for adopters under a review obligation — a `git tag` baseline, git history as the audit trail, and the admission record as the review/approval record. No new schema. |
...
| "How do we baseline the model for an audit / review, and show who approved it?" | [Baseline, Audit Trail and Approval Record](baseline-and-audit-trail.md) |
