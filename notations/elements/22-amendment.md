...
- The canon `CHANGE` (ArchiMate Gap) elements an AMENDMENT motivates: [IDS_AND_REFERENCES.md](../IDS_AND_REFERENCES.md) §3.1 (`CHANGE`); used by DGCA ([views/02-dgca.md](../views/02-dgca.md)) and Activities ([views/07-activities.md](../views/07-activities.md)).
