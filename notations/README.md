...
| [08-blocks.md](views/08-blocks.md) | `blocks` | A grid canvas with layers — deep architectural overviews (containment tree, the degenerate case) and matrix views (RACI, coverage grids) alike. | `*.blocks.transitrix.yaml` | documented |
