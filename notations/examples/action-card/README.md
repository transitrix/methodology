...
**Spec:** [`notations/views/18-action-card.md`](../../views/diagrams/18-action-card.md)
...
- Action-card milestones are **distinct** from the zero-duration "schedule milestones" defined in [`07-action.md`](../../views/diagrams/07-action.md) §5.9. The two coexist by design: schedule milestones drive critical-path computation; action-card milestones anchor narrative gates. The reconciliation is documented in [18-action-card.md §8](../../views/diagrams/18-action-card.md).
