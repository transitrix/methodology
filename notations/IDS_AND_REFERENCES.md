...
| `ROLE`, `ACTOR`, `LOCATION`, `BUSINESS_SERVICE` | within the organisation's element catalogue (`elements/02_business/`). |
...
| `NODE` | within the organisation's element catalogue (`elements/04_technology/nodes/`), one file per NODE. |
| `TECHNOLOGY_SERVICE` | within the organisation's element catalogue (`elements/04_technology/services/`), one file per TECHNOLOGY_SERVICE. |
