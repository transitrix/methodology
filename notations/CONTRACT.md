...
| `REQ-VERIF-COVERAGE-001` | warning | REQUIREMENT (cross-cutting) | REQUIREMENT has no VERIFICATION targeting it — engineering V&V gap, the verification analogue of `REQ-COVERAGE-001` | [15-requirement.md](elements/15-requirement.md) §4 |
